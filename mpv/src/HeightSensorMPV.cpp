...
public:
    ...
    HeightSensorMPV()
        ...
        left_sensor_publisher_ = this->create_publisher<std_msgs::msg::Int32>("left_sensor_mpv", 10);
        right_sensor_publisher_ = this->create_publisher<std_msgs::msg::Int32>("right_sensor_mpv", 10);
